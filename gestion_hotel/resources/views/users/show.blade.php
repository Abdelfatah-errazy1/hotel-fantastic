...
<div class="max-w-2xl mx-auto">
  ...
  <section class="px-6 py-8">
    <main class=" mx-auto mt-6   bg-gray-50 border border-gray-200 p-10 rounded-xl  ">
      ...
      <form action="{{ route('roomsAdmin.update',$model->idRoom) }}" method="post" class="grid grid-cols-2"  >
      @csrf
      ...
      <div class="mb-6  ">
        ...
        <a id="modalbtn" class="uppercase font-bold border border-gray-500 py-1 my-5 px-6   rounded-3xl text-white bg-blue-500 hover:bg-blue-600 mr-5" >Add Image</a>
      </div>
              ...
              @foreach ($collection as $item )
                ...
                <tr class="bg-white border-b  hover:bg-gray-100 ">
                  ...
                  <td class="px-6 py-4 text-right">
                    <a href="{{ route('imageRooms.delete',$item->idIR) }}" class="font-medium bg-red-600 p-2  rounded text-white hover:bg-red-500 hover:underline">delete</a>
                  </td>
                </tr>
              @endforeach
          @endisset
